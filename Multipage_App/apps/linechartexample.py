...
app.ayout = html.Div([
    ...
    dbc.Row (dbc.Col (html.Div ("Gráfico de Linea"), width=6,style={"border":"2px black solid"}) ),
    ...
    [ 
        dbc.Col ( html.Div(
            dcc.Graph(id='line-chart'), width=24,
            ), 
        ),
        dbc.Col (
            html.Div(
            html.Label(['Fuentes:'],style={'font-weight': 'bold', "text-align": "left"}),
            dcc.Dropdown(
